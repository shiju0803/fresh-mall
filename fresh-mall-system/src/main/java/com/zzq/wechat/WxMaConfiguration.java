...
public class WxMaConfiguration {
    ...
    private final static String FRESH_MALL_WEIXIN_MA_SERVICE = "fresh_mall_weixin_ma_service";
    ...
    public static WxMaService getWxMaService() {
        WxMaService wxMaService = maServices.get(FRESH_MALL_WEIXIN_MA_SERVICE);
        //增加一个redis标识
        if(wxMaService == null){
            ...
            maServices.put(FRESH_MALL_WEIXIN_MA_SERVICE, wxMaService);
            routers.put(FRESH_MALL_WEIXIN_MA_SERVICE, newRouter(wxMaService));
        }
        return wxMaService;
    }
    /**
    ...
    public static void removeWxMaService(){
        maServices.remove(FRESH_MALL_WEIXIN_MA_SERVICE);
        routers.remove(FRESH_MALL_WEIXIN_MA_SERVICE);
    }
