...
public class WxMpConfiguration {
    ...
    private final static String FRESH_MALL_WEIXIN_MP_SERVICE = "fresh_mall_weixin_mp_service";
    ...
    public static WxMpService getWxMpService() {
        ...
        WxMpService wxMpService = mpServices.get(FRESH_MALL_WEIXIN_MP_SERVICE);
        //增加一个redis标识
        if (wxMpService == null) {
            ...
            mpServices.put(FRESH_MALL_WEIXIN_MP_SERVICE, wxMpService);
            routers.put(FRESH_MALL_WEIXIN_MP_SERVICE, newRouter(wxMpService));
        }
        return wxMpService;
    }
    ...
    public static void removeWxMpService() {
        RedisUtils.deleteKeys(FRESH_MALL_WEIXIN_MP_SERVICE);
        mpServices.remove(FRESH_MALL_WEIXIN_MP_SERVICE);
        routers.remove(FRESH_MALL_WEIXIN_MP_SERVICE);
    }
    ...
    public static WxMpMessageRouter getWxMpMessageRouter() {
        return routers.get(FRESH_MALL_WEIXIN_MP_SERVICE);
    }
