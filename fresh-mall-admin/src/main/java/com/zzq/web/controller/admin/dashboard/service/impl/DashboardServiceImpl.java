package com.zzq.web.controller.admin.dashboard.service.impl;
...
import com.zzq.order.domain.vo.OrderTimeDataVo;
...
public class DashboardServiceImpl implements DashboardService {
    ...
    public OrderTimeDataDTO getCount(Long storageId) {
        ...
        orderTimeDataDto.setOrderCount(orderMapper.selectCount(new LambdaQueryWrapper<StoreOrder>().eq(storageId!=null,StoreOrder::getStoreId,storageId)));
        ...
        if (ObjectUtils.isEmpty(storageId)) {
            ...
            orderTimeDataDto.setGoodsCount(stockMapper.selectCount(new LambdaQueryWrapper<Stock>().eq(storageId!=null,Stock::getStorageId,storageId)));
        }
    ...
    public OrderTimeDataVo getShoperOrderTimeData(Long storageId) {
        ...
        wrapperOne
                .ge(StoreOrder::getPayTime, today)
                .isNotNull(StoreOrder::getPayTime)
                .eq(storageId!=null,StoreOrder::getStoreId,storageId)
                .in(StoreOrder::getStatus, OrderStatusType.COMPLETE.getCode(),OrderStatusType.WAIT_APPRAISE.getCode());
        ...
        wrapperTwo
                .lt(StoreOrder::getPayTime, today)
                .ge(StoreOrder::getPayTime, yesterday)
                .eq(storageId!=null,StoreOrder::getStoreId,storageId)
                .in(StoreOrder::getStatus, OrderStatusType.COMPLETE.getCode(),OrderStatusType.WAIT_APPRAISE.getCode());
        ...
        wrapperThree
                .ge(StoreOrder::getPayTime, nowMonth)
                .eq(storageId!=null,StoreOrder::getStoreId,storageId)
                .in(StoreOrder::getStatus, OrderStatusType.COMPLETE.getCode(),OrderStatusType.WAIT_APPRAISE.getCode());
        ...
        //上周成交额
        LambdaQueryWrapper<StoreOrder> wrapperLastWeek = new LambdaQueryWrapper<>();
        wrapperLastWeek
                .lt(StoreOrder::getPayTime, today)
                .ge(StoreOrder::getPayTime, lastWeek)
                .eq(storageId!=null,StoreOrder::getStoreId,storageId)
                .in(StoreOrder::getStatus, OrderStatusType.COMPLETE.getCode(),OrderStatusType.WAIT_APPRAISE.getCode());
