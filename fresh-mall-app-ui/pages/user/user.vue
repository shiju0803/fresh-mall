<template>
	<view>
		<view v-if="storage">
			<view class="bg-user-gradual-green" style=" background-image: url(../../static/user/bg.png);">
				<view :style="'height:'+statusBarHeight+'px;'" style="width: 750rpx;display: flex; position: relative;">
				</view>
				...
				<view class="padding-top-lg flex justify-between align-end padding-lr" style="padding-top: 30rpx;">
					...
					<view @click="navTo('/pages/user/profile')" style="position: relative;padding-right: 8rpx;">
						<image
							:src="hasLogin && userInfo.avatar ? userInfo.avatar :'../../static/user/touxiang-@2x.png'"
							class="round" mode="aspectFill" style="width: 144rpx;height: 144rpx;"></image>
			...
			<view class="margin-lr bg-white shadow"
				...
				<view class="flex justify-around align-center padding-top-sm">
					<view @click="navTo('/pages/order/list?state=0')"
						class="flex align-center justify-center flex-direction" style="width: 108rpx;">
						<image src="../../static/user/all_order.png" mode="aspectFit"
							style="width: 46rpx;height: 50rpx;"></image>
						<view style="padding-top: 20rpx;font-size: 24rpx;color: #272B54;">全部订单</view>
					</view>
					<view @click="navTo('/pages/order/list?state=1')"
						class="flex align-center justify-center flex-direction" style="width: 108rpx;">
						<image src="../../static/user/waitpay.png" mode="aspectFit" style="width: 46rpx;height: 50rpx;">
						</image>
						<view style="padding-top: 20rpx;font-size: 24rpx;color: #272B54;">待付款</view>
					</view>
					<view @click="navTo('/pages/order/list?state=2')"
						class="flex align-center justify-center flex-direction" style="width: 108rpx;">
						<image src="../../static/user/daishouhuo@3x.png" mode="aspectFit"
							style="width: 46rpx;height: 50rpx;"></image>
						<view style="padding-top: 20rpx;font-size: 24rpx;color: #272B54;">待收货</view>
					</view>
					<view @click="navTo('/pages/order/list?state=3')"
						class="flex align-center justify-center flex-direction" style="width: 108rpx;">
						<image src="../../static/user/shouhou@3x.png" mode="aspectFit"
							style="width: 46rpx;height: 50rpx;"></image>
			...
			<view class="padding-lr padding-tb-sm">
				<image :src="banner" mode="aspectFitFull" style="width: 690rpx;height: 184rpx;"></image>
			</view>
			...
			<view class="margin-lr margin-bottom-sm shadow bg-white" style="border-radius: 10rpx;">
				<view @click="navTo('/pages/address/list')" class="flex align-center padding">
					<image src="../../static/user/location@3x.png" mode="aspectFit" style="width: 32rpx;height: 36rpx;">
					</image>
			...
			<view class="margin-lr margin-bottom-sm shadow bg-white" style="border-radius: 10rpx;">
				<view @click="navTo('/pages/product/favorite')" class="flex align-center padding">
					<image src="../../static/user/collect@3x.png" mode="aspectFit" style="width: 32rpx;height: 36rpx;">
					</image>
				...
				<view @click="navTo('/pages/set/set')" class="flex align-center padding">
					<image src="../../static/user/setting@3x.png" mode="aspectFit" style="width: 32rpx;height: 36rpx;">
					</image>
				...
				<view @click="navTo('/pages/notice/notice')" class="flex align-center padding">
					<image src="../../static/user/notice@3x.png" mode="aspectFit" style="width: 32rpx;height: 36rpx;">
					</image>
	...
	export default {
		...
		onLoad() {
			...
			this.$api.request('get', 'carousel/app/getCarouselActive', {
				...
				this.banner = JSON.parse(res.data[0].imgUrl)[0].url;
			})
		},
		// #ifndef MP
