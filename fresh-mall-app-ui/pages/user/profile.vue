	...
	<view>
		...
		<view style="height: 120rpx;"
			...
			<image @click="chooseImg" :src="userInfo.avatar ? userInfo.avatar :'../../static/user/touxiang-@2x.png'"
				class="round" mode="aspectFill" style="width: 90rpx;height: 90rpx;"></image>
		</view>
		<view style="height: 100rpx;"
			...
			<view class="flex align-center">
				...
				<input @blur="changeName" @confirm="changeName" v-model="userInfo.nickname" placeholder="请输入昵称"
					class="text-df" style="text-align: right;" />
		...
		<view style="height: 100rpx;"
			...
			<view class="flex align-center">
				<view @click="changeGender(1)" class="flex align-center">
					<image :src="gender == 1 ?'/static/cart/selected.png':'/static/cart/select.png'" mode="aspectFill"
				...
				<view @click="changeGender(2)" class="flex align-center" style="padding-left: 80rpx;">
					<image :src="gender == 2 ?'/static/cart/selected.png':'/static/cart/select.png'" mode="aspectFit"
						style="width: 40rpx;height: 40rpx;"></image>
		...
		<view style="height: 100rpx;"
			...
			<view class="flex align-center">
				...
				<image src="../../static/icon/arrow_right.png" mode="aspectFit" class="icon-right"></image>
			</view>
		</view>
		<view style="height: 100rpx;" class=" bg-white flex justify-between align-center padding-lr padding-tb-s">
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			this.phone = this.userInfo.phone[0] + this.userInfo.phone[1] + this.userInfo.phone[2] + '****' + this.userInfo
				.phone[7] + this.userInfo.phone[8] + this.userInfo.phone[9] + this.userInfo.phone[10]
		},
		methods: {
			chooseImg() {
