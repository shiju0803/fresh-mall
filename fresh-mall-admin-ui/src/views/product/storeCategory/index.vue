...
<script>
import { getStoreCategory, delStoreCategory, addStoreCategory, updateStoreCategory, pageStoreCategoryTree, listStoreCategoryTree } from '@/api/product/storeCategory'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      pageStoreCategoryTree(this.queryParams).then(({ data }) => {
    ...
    listStoreCategoryTree() {
      return new Promise((resolve, reject) => {
        pageStoreCategoryTree().then(({ data }) => {
          const { content } = data
